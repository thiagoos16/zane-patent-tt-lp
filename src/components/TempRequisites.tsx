...
export function TempRequisites() {
    return (
        <VStack>
            <Text fontWeight="bold" fontSize="4xl" color="green.600">Busca</Text>
            <Box>
            ...
            <Box textAlign="center">
                <Text mt="5" mb="3" fontWeight="bold" fontSize="2xl" color="green.600">Abrangência da busca</Text>
                <Text textAlign="justify" sx={{"text-indent":"50px"}}>
                ...
                <br/>
                <Text textAlign="justify" sx={{"text-indent":"50px"}}>
                    A seguir são apresentadas <b>as duas formas</b> de executar uma busca na base de patentes do
                    INPI.
                </Text>
            </Box>
            
            <Box textAlign="center">
                <Text mt="5" mb="4" fontWeight="bold" color="green.600" fontSize="2xl">
                    Procedimentos para a busca nas Bases do INPI
                </Text>
            ...
            <Box>
                <Text mt="5" mb="4" fontWeight="bold" color="green.600" fontSize="2xl">
                    Pesquisa na base de dados do INPI
                </Text>
            </Box>

            <Box>
                <Box>
                    <Box flex="1" textAlign="left" fontWeight="bold" color="green.600">
                        1. Pesquisa Básica
                    </Box>
